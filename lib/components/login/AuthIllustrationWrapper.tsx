...
// Props for the AuthIllustrationWrapper
interface AuthIllustrationWrapperProps {
  children: ReactNode
}

// Styled component for the illustration wrapper
...
const AuthIllustrationWrapper = ({ children }: AuthIllustrationWrapperProps) => {
